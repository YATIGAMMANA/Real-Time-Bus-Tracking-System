          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                const Text(
                  'At B.Pilot, we\'re dedicated to providing excellent support to our users. If you have any questions, encounter issues, or need assistance while using our app, there are several ways to get help:',
                ...
                const SizedBox(height: 10),
                const Text(
                  'Connect with us on social media platforms such as Twitter, Facebook, or Instagram. We regularly share updates, announcements, and tips to help you make the most out of your B.Pilot experience. Feel free to send us a message or tag us in your posts if you have any questions or feedback.',
                  style: TextStyle(fontSize: 18),
                ),
                const SizedBox(height: 20),
                const Text(
                ...
                const SizedBox(height: 10),
                const Text(
                  'We value your feedback and suggestions for improving the app. If you have ideas for new features, improvements, or enhancements, please let us know! Your input helps us prioritize our development efforts and ensure that B.Pilot meets your needs.',
                  style: TextStyle(fontSize: 18),
                ),
                const SizedBox(height: 20),
                const Text(
                ...
                const SizedBox(height: 20),
                const Text(
                  'Remember, we\'re here to help make your bus travel experience as smooth and enjoyable as possible. Don\'t hesitate to reach out if you need assistance or have any questions!',
                  style: TextStyle(fontSize: 18),
                ),
                const SizedBox(height: 20),
                const Text(
